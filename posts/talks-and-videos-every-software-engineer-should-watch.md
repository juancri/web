...
I love watching technical talks. It's a way to lean from other and continue learning.

This is a small compilation of talks that I have anjoyed. I'll try to keep this post updated as I remember or discover new taks.
...
- [Facebook's Code Checker - Computerphile](https://www.youtube.com/watch?v=tKR2UZdRpV0)
- [The Future of Programming Languages at the Confluence of Paradigms](https://www.youtube.com/watch?v=ya1xDCCMh7g)
...
- [Tech Talk: Linus Torvalds on git](https://www.youtube.com/watch?v=4XpnKHJAok8): Linus, being the creator of git and the Linux kernel, explains how git works for their use case.
- [Lecture 6: Version Control (git) (2020)](https://www.youtube.com/watch?v=2sjqTHE0zok)
- [Dissecting Git's Guts, Emily Xie - Git Merge 2016](https://www.youtube.com/watch?v=Y2Msq90ZknI)
...
- [Five Ways to Break a Git Repository - Edward Thomson](https://www.youtube.com/watch?v=uwJI-_08mCs)
...
- [dotJS 2019 - Maggie Johnson-Pint - Programming in the 4th Dimension - Making Time Make Sense](https://www.youtube.com/watch?v=0oY8CnWP5R8)
- [dotJS 2019 - Stefan Judis - Regular expressions my secret love](https://www.youtube.com/watch?v=KIp7lhL7AXg)
- [Fun With Bluetooth](https://www.youtube.com/watch?v=XDc5HUVMI5U)
...
- [Functional Reactive Programming with RxJava](https://www.youtube.com/watch?v=Dk8cR1Kxj0Y)
- [Droidcon SF - Common RxJava Mistakes](https://www.youtube.com/watch?v=QdmkXL7XikQ)
- [Reactive microservices end to end from RxJava to the wire with gRPC](https://www.youtube.com/watch?v=0f6aCvBJtZY)

### C#

- [Change your habits: Modern techniques for modern C# - Bill Wagne](https://www.youtube.com/watch?v=aUbXGs7YTGo)
...
- [How Telephone Phreaking Worked](https://www.youtube.com/watch?v=4tHyZdtXULw)
...
- [Fiber Tapping - Monitoring Fiber Optic Connections](https://www.youtube.com/watch?v=PbipefyfkNY)
...
- [Reverse engineering obfuscated JavaScript - PopUnder Chrome 59](https://www.youtube.com/watch?v=8UqHCrGdxOM)
...
- [Reverse Engineering Introduction Walkthrough](https://www.youtube.com/watch?v=28JHPOUZvDw)
- [Nintendo Switch (NVIDIA Tegra X1) - BootROM Vulnerability](https://www.youtube.com/watch?v=L3PPWVPg2WI)
- [Playstation 4 Hacked by fail0verflow presentation from 33C3](https://www.youtube.com/watch?v=VpB49dhk2uQ)
- [Self-aware Video: it knows its own YouTube Video ID?](https://www.youtube.com/watch?v=j70AA9arThc)
- [Patching Binaries (with vim, Binary Ninja, Ghidra and radare2) - bin 0x2F](https://www.youtube.com/watch?v=LyNyf3UM9Yc)
...
- [The Heap: what does malloc() do? - bin 0x14](https://www.youtube.com/watch?v=HPDBOhiKaD8)
- [Finding iOS Kernel Exploit // SockPuppet Jailbreak - CVE-2019-8605](https://www.youtube.com/watch?v=YV3jewkUJ54)
...
- [Solving Nintendo HireMe!!! with "Basic" Math](https://www.youtube.com/watch?v=thbZwi6WwIE)
- [Hello World on Sega Megadrive - Computerphile](https://www.youtube.com/watch?v=gNHCxH35wYU)
...
- [Video Streaming Problems - Computerphile](https://www.youtube.com/watch?v=bSTEIWmI3z8)
- [Reason for ARM (Acorn Archimedes at 30) - Computerphile](https://www.youtube.com/watch?v=rh7kpkwXnwA)

### Stand-up Maths

These videos are more about maths than software engineering, but we should know this stuff, right?

- [How many different Youtube videos are possible?](https://www.youtube.com/watch?v=5Yy_unGaD-w)
- [There is only One True Parabola](https://www.youtube.com/watch?v=hoh4TmPzu1w)

## Extras

These vidos are not really about software development, but I think they may be super interesting for devs
